...
void ObjectPlaceScene::handleMouseClick(double x, double y)
{
...
void ObjectPlaceScene::create()
{
    ...
    ShaderLoader vertnotex("../zpg/Shaders/uni.vert", GL_VERTEX_SHADER);
    ShaderLoader fragnotex("../zpg/Shaders/coloruni/phongmulti.frag", GL_FRAGMENT_SHADER);
    ...
    shaders = { &vertnotex, &fragnotex };

    ShaderProgram* placeshader = new ShaderProgram(shaders);
...
"../zpg/Objects/sky/negz.jpg",   // -Z
    ...
    this->setClickCreateShader(placeshader);

    //this->setClickCreateModel(shrek);
    //this->setClickCreateTexture(shrekTexture);
